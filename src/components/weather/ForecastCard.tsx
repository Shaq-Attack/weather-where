...
export function ForecastCard({ daily, hourly, isCelsius, timezoneOffset }: ForecastCardProps) {
  ...
  return (
    ...
    >
      ...
      <CardBody style={{ padding: "1.5rem" }}>
        ...
        >
          <TabStripTab title="Daily Forecast" aria-label="Daily weather forecast">
                ...
                {daily.slice(0, 7).map((day, index) => (
                  ...
                  >
                    <CardBody style={{ padding: "1rem" }}>
                      ...
                      {day.pop > 0 && (
                        <div style={{ fontSize: "0.8rem", color: "#3498db", marginTop: "0.25rem" }}>
                          <DropletIcon size={12} style={{ verticalAlign: "middle" }} />
          ...
          <TabStripTab title="Hourly Forecast" aria-label="Hourly weather forecast">
            <div style={{ padding: "1rem 0" }}>
              <div style={{ marginBottom: "1.5rem" }}>
                <h4 style={{ margin: "0 0 1rem 0" }}>24-Hour Temperature Trend</h4>
                  ...
                  >
                    <CardBody style={{ padding: "0.75rem" }}>
                      ...
                      <div style={{ fontSize: "0.7rem", color: "#666", marginTop: "0.25rem" }}>
                        <DropletIcon size={10} style={{ verticalAlign: "middle" }} />
        ...
        >
          <div style={{ padding: "1rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
              ...
              <div>
                <h3 style={{ margin: 0 }}>{selectedDay.weather[0].description}</h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.5rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                ...
                <span>Day Temp: {formatTemperature(selectedDay.temp.day, tempUnit)}</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <DropletIcon size={18} />
            ...
            <div style={{ maxHeight: "200px", overflowY: "auto", border: "1px solid #e0e0e0", borderRadius: "4px" }}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead style={{ backgroundColor: "#f5f5f5" }}>
                  <tr>
                    <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "1px solid #e0e0e0" }}>Time</th>
                    <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "1px solid #e0e0e0" }}>Temp</th>
                    <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "1px solid #e0e0e0" }}>Condition</th>
                    <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "1px solid #e0e0e0" }}>Rain %</th>
                  </tr>
                </thead>
                <tbody>
                  {getHourlyForDay(selectedDay).map((hour, index) => (
                    <tr key={hour.dt} style={{ borderBottom: index < getHourlyForDay(selectedDay).length - 1 ? "1px solid #e0e0e0" : "none" }}>
                      <td style={{ padding: "0.5rem" }}>{formatTime(hour.dt, timezoneOffset)}</td>
            ...
            <div style={{ textAlign: "center", marginTop: "1.5rem" }}>
              <Button themeColor="primary" onClick={closeDialog}>Close</Button>
            </div>
          </div>
        </Dialog>
      )}
