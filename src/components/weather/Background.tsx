    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            currentGradient ||
            "linear-gradient(180deg, #87CEEB 0%, #FF6347 100%)",
          zIndex: -2,
      ...
      <div
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.1) 25%, rgba(0,0,0,0.15) 50%, rgba(0,0,0,0.2) 75%, rgba(0,0,0,0.25) 100%)",
          zIndex: -1,
          pointerEvents: "none",
        }}
      />
